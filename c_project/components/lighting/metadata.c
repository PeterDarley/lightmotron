...
const pattern_metadata_t pattern_metadata_table[] = {
    ...
    {
        .name = "rainbow",
        .description = "Rainbow hue cycling across the strip",
        .required = {"target"},
        .required_count = 1,
        .optional = {"duration", "number", "saturation"},
        .optional_count = 3,
        .color_count = 0,
    },
    {
        .name = "color_wipe",
        .description = "Progressively fill then wipe with two colors",
        .required = {"target", "colors"},
        .required_count = 2,
        .optional = {"duration"},
        .optional_count = 1,
    ...
    },
    {
        ...
        .required = {"target"},
        .required_count = 1,
        .optional = {"duration", "cooling", "sparking"},
        .optional_count = 3,
        .color_count = 0,
    },
    {
        .name = "gradient",
        .description = "Color gradient across the strip (optionally scrolling)",
        .required = {"target", "colors"},
        .required_count = 2,
        .optional = {"duration"},
        .optional_count = 1,
    ...
    {
        .name = "warp_pulse",
        .description = "Pulse expanding from the center to both ends",
        .required = {"target", "colors"},
        .required_count = 2,
        .optional = {"period", "width"},
        .optional_count = 2,
        .color_count = 2,
    },
    {
        .name = "theater_chase",
        .description = "Evenly spaced dots marching along the strip",
        .required = {"target", "colors"},
        .required_count = 2,
        .optional = {"duration", "spacing", "width", "reverse"},
        .optional_count = 4,
        .color_count = 2,
    },
    {
        .name = "heartbeat",
        .description = "Double-thump heartbeat rhythm",
        .required = {"target", "colors"},
        .required_count = 2,
        .optional = {"period"},
        .optional_count = 1,
...
const filter_metadata_t filter_metadata_table[] = {
    ...
    {
        .name = "afterglow",
        .description = "Fading trails / afterglow",
        .optional = {"decay"},
        .optional_count = 1,
    },
    {
        .name = "tint",
        .description = "Color tint overlay (gel)",
        .optional = {"color", "strength"},
        .optional_count = 2,
    },
    {
        .name = "shimmer",
        .description = "Moving shimmer brightness wave",
        .optional = {"wavelength", "speed", "depth"},
        .optional_count = 3,
    },
    {
        .name = "hue_shift",
        .description = "Rotate colors' hue",
        .optional = {"speed", "offset"},
        .optional_count = 2,
    },
    {
        .name = "saturation",
    ...
    {
        .name = "vignette",
        .description = "Dim the ends of the range",
        .optional = {"falloff", "invert"},
        .optional_count = 2,
    },
    { .name = NULL },
};
